...
<p class="informationTit01">「LED照明用点灯電源【LEB】/【LEC】シリーズ」の生産中止のご案内</p>
<p class="mt15">詳細は<a href="<?php echo $TJF_HTTP.$_SERVER['SERVER_NAME'].'/product/pdf/LEB_LECシリーズ生産中止のご案内.pdf'; ?>" target="_blank">こちら</a>からご確認ください。</p>
...
<div class="informationTxtBox01">
<p class="informationTit01">「高周波蛍光灯用電源【LSH】シリーズ」の仕様変更のご案内</p>
<p class="mt15">詳細は<a href="<?php echo $TJF_HTTP.$_SERVER['SERVER_NAME'].'/product/pdf/【LSH】シリーズ仕様変更のご案内.pdf'; ?>" target="_blank">こちら</a>からご確認ください。</p>
<!-- /informationTxtBox01 --></div>
</li>
<li>
<div class="informationDate01">
...
<div class="informationTxtBox01">
<p class="informationTit01">2019年度新卒採用の応募受付を開始しました。</p>
<p class="informationTxt01">京都電機器株式会社では、採用特設サイトで、2019年度の新卒採用応募受付を開始しました。<br>弊社にご興味のある方はぜひ一度ご覧ください。</p>
