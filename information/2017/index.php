...
<p class="informationTit01">2018年度新卒採用の応募受付を開始しました。</p>
<p class="informationTxt01">京都電機器株式会社では、採用特設サイトで、2018年度の新卒採用応募受付を開始しました。<br>弊社にご興味のある方はぜひ一度ご覧ください。</p>
...
<div class="informationTxtBox01">
<p class="informationTit01">光学総合カタログをリニューアルしました。</p>
<p class="mt05"><a href="<?php echo $TJF_HTTP.$_SERVER['SERVER_NAME'].'/product/catalog/'; ?>" target="_blank">[光学総合カタログ 2016-2017]</a></p>
<!-- /informationTxtBox01 --></div>
</li>
</ul>
</section>
