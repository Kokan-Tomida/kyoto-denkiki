...
<p class="informationTit01">「フラットパネル照明FP-302、305、402」のメンテナンス並びに生産終了のご案内 </p>
<p class="informationTxt01">詳細は<a href="<?php echo $TJF_HTTP.$_SERVER['SERVER_NAME'].'/stop/'; ?>">「生産中止製品について」</a>ページよりご確認ください。 </p>
...
<div class="informationTxtBox01">
<p class="informationTit01">中国文ページを開設しました。</p>
<!-- /informationTxtBox01 --></div>
</li>
<li>
<div class="informationDate01">
...
<div class="informationTxtBox01">
<p class="informationTit01">ホームページをリニューアルしました。</p>
<!-- /informationTxtBox01 --></div>
</li>
<li>
<div class="informationDate01">
...
<div class="informationTxtBox01">
<p class="informationTit01">新製品を掲載しました。</p>
<p class="informationTxt01"><a href="<?php echo $TJF_HTTP.$_SERVER['SERVER_NAME'].'/'; ?>">TOPページ</a>の「新製品情報」からもアクセスしてください。</p>
<!-- /informationTxtBox01 --></div>
</li>
<li>
<div class="informationDate01">
...
<div class="informationTxtBox01">
<p class="informationTit01">「キセノン管ストロボ照明装置」の生産終了のご案内</p>
<p class="informationTxt01">詳細は<a href="<?php echo $TJF_HTTP.$_SERVER['SERVER_NAME'].'/stop/'; ?>">「生産中止製品について」</a>ページよりご確認ください。</p>
<!-- /informationTxtBox01 --></div>
</li>
<li>
