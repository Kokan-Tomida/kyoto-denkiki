...
<title>LSC-SN1 series｜京都電機器株式会社</title>

<meta name="keywords" content="LSC-SN1 series,高周波点灯電源,画像処理用LED照明,キセノン管ストロボ装置,京都電機器">
...
<figure><img src="images/mainimg_01.jpg" width="708" height="147" alt="光量一定制御用センサーボード LSC-SN1 series"></figure>
<div class="productMainimgSeriesBoxIn02">	
<p class="productSeriesTitle01">光量一定制御用センサーボード</p>
<h2 class="productSeriesH201">LSC-SN1 series</h2>
</div>
<!-- /productMainimgSeriesBox01 --></div>

<div class="productMainimgKasoBox02">
<p class="productKasoTitle01"><span>光量一定制御用のセンサーと増幅回路を組み合わせたセンサーボードです</span></p>
...
<tr>
<td class="taL">センサー感度波長範囲</td>
<td>320&#xFF5E;730nm</td>
</tr>
<tr>
<td class="taL">センサーピーク波長</td>
<td>560nm</td>
</tr>
</table>
<!-- /productW430px --></div>
...
<div class="productTabBox01">
<h3 class="productTabH301">分光感度特性</h3>
<figure><img class="img_basic02" src="images/img_feature01.gif" width="266" height="253" alt="分光感度特性"></figure>
...
<figure><img src="images/img_drawing01.gif" width="667" height="231" alt="外形図" class="img_basic02"></figure>
<!-- /productTabBox01 --></div>
<!-- download -->
<?php include($_SERVER['DOCUMENT_ROOT'].'/common/include/download02.php'); ?>
<!-- /download -->
