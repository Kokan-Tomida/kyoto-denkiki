...
$lang = 0;
$hassocial = 0;
$h1 = "送信完了｜見積希望/製品に関するお問い合わせ｜京都電機器株式会社";
?>
<!DOCTYPE html>
...
<title>送信完了｜見積希望/製品に関するお問い合わせ｜京都電機器株式会社</title>
...
<p class="contactLocation01"><img src="../images/img_contact_location03.png" width="960" height="47" alt="STEP3. 送信完了"></p>

<div class="contactWrap01">
<div class="contactWrapIn01">
<p class="contactFormTxt01">送信が完了しました。お問い合わせ頂きありがとうございました。 </p>
