...
<title>確認画面｜新規会員登録｜京都電機器株式会社</title>
...
<form action="addnew_confirm.php" method="post">
<p class="memberForm01InfoTxt01">入力内容をご確認いただき、間違いがなければ「送信する」ボタンで送信してください。</p>
...
<th class="memberAddnewMust01"><span>必須</span></th>
<td><?php if ($data['agree']): ?><p class="memberAddnewAgreeTxt03">同意する</p><?php endif; ?></td>
</tr>
</table>

<div class="memberAddnewBox02">
<p class="memberAddnewback01"><input type="button" value="戻る" onclick="location.href='addnew.php?back=1'"></p>
<p class="memberAddnewSend02"><input type="submit" name="to_complete" value="送信する"></p>
