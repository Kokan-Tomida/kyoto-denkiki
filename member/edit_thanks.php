...
<title>編集完了｜登録情報編集｜京都電機器株式会社</title>
<meta name="keywords" content="編集完了,カスタム電源,画像処理用LED照明,瞬低保護装置,京都電機器">
<meta name="description" content="編集完了。京都電機器はインバーター電源設計、高圧電源設計を基盤とし、組込電源やカスタム電源にも対応。画像処理用LED照明や専用電源もランナップ。瞬低保護装置では国内トップシェア。">
...
<p class="memberForm01InfoTxt01">編集が完了いたしました。</p>
