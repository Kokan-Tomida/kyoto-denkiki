...
<title>退会申請｜京都電機器株式会社</title>
<meta name="keywords" content="退会申請,カスタム電源,画像処理用LED照明,瞬低保護装置,京都電機器">
<meta name="description" content="退会申請。京都電機器はインバーター電源設計、高圧電源設計を基盤とし、組込電源やカスタム電源にも対応。画像処理用LED照明や専用電源もランナップ。瞬低保護装置では国内トップシェア。">
...
<p class="memberForm01InfoTxt01">下記会員様の退会申請を行います。</p>
...
<p class="memberAddnewSend02"><input type="submit" name="to_complete" value="退会申請"></p>
