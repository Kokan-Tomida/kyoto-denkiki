  ...
  <div id="contents_box">
   ...
   <div class="left btn01_on"><a href="a4140.php">ダウンロード履歴</a></div>
   </div>
   
   <div id="search_box02">
   <form method="post" action="a4140.php" name="frm" onKeyPress="setOnEnterClickButton('to_search','frm');">
   ...
   <div class="tbbg01">
    <table width="960" border="0" cellspacing="1" cellpadding="10">
     <tr>
       <th width="29">No</th>
       <th width="170" class="txtleft">ダウンロード日時</th>
       <th width="150" class="txtleft">法人名 / ご担当者名</th>
       <th width="385" class="txtleft">カテゴリー / 製品名</th>
       <th width="120" class="txtleft">ファイル</th>
       </tr>
       <?list?>
     </table>
   </div>
   ...
   <!-- pagenavibox start -->
   <div id="pagenavibox" class="mg-top10 mg-bottom20">
    <ul>
   <?pagenavi?>
	</ul>
	</div>
