  ...
  <div id="contents_box">
   ...
   <div id="pankuzu"><a href="a1100.php">製品中カテゴリ管理 一覧</a> &gt; 新規登録</div>
   
   <form method="post" action="a1111.php" name="frm" enctype="multipart/form-data">
   <div id="search_box02">
    ...
    <div class="clearfix mg-top18">
     ...
     <div class="left pd-left70"><input type="file" size="30" maxlength="30" class="gazo" name="image_path" /></div>
    </div>
    <div class="pd-left96">70×70pix JPEG</div>
        
    <div class="mg-top18"><?validate_msg?></div>
    <div class="mg-top18 pd-left96"><input type="submit" name="to_regist" value=" " class="regist_btn" onclick="return confirm('登録します.よろしいですか？');" /></div>
