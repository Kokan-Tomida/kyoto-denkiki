  ...
  <div id="contents_box">
   ...
   <div id="pankuzu"><a href="a3100.php">会員情報管理 一覧</a> &gt; 編集</div>
   
    <form method="post" action="a3121.php" name="frm" >
    ...
    <div class="clearfix mg-top15">
     ...
     <div class="left pd-left10">
       <input class="lo01_nowidth" type="text" name="member_pwd" value="<?member_pwd?>" size="60" <?ime_style?>>
     </div>
    </div>
    ...
    <div class="clearfix mg-top15">
      <div class="left text01_120 pd-top8">管理備考</div>
      <div class="left pd-left10">
        <textarea class="lo01_nowidth" name="admin_note" rows="4" cols="70"><?admin_note?></textarea>
      </div>
    </div>

    <div class="mg-top18"><?validate_msg?></div>
    <input type="hidden" name="target" value="<?target?>">
    <div class="mg-top18 pd-left130"><input type="submit" name="to_regist" value=" " class="regist_btn" onclick="return confirm('登録します.よろしいですか？');" /></div>
