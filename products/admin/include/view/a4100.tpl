  ...
  <div id="contents_box">
   ...
   <div class="left btn01_on"><a href="a4100.php">全て</a></div>
   <div class="left btn01"><a href="a4110.php">貸出履歴</a></div>
   <div class="left btn01"><a href="a4120.php">問い合わせ履歴</a></div>
   <div class="left btn01"><a href="a4130.php">ログイン履歴</a></div>
   <div class="left btn01"><a href="a4140.php">ダウンロード履歴</a></div>
   </div>
   
   <div id="search_box02">
   <form method="post" action="a4100.php" name="frm" onKeyPress="setOnEnterClickButton('to_search','frm');">
    <div class="text01 pd-top42">
    期間
    <input type="text" name="start_date" class="txt01" id="from" value="<?start_date?>">
    　から　
    <input type="text" name="end_date" class="txt01" id="to" value="<?end_date?>">
   </div>
   ...
   <?search_result?>
   <!-- pagenavibox start -->
   <div id="pagenavibox" class="mg-top20 mg-bottom10">
    <ul>
	<?pagenavi?>
    </ul>
   </div>
   ...
   <div class="tbbg01">
    <table width="960" border="0" cellspacing="1" cellpadding="10">
     <tr>
       <th width="30">No</th>
       <th width="110" class="txtleft">年月日時</th>
       <th width="182" class="txtleft">法人名</th>
       <th width="120" class="txtleft">ご担当者名</th>
       <th width="100" class="txtleft">履歴種別</th>
       <th width="150" class="txtleft">&nbsp;</th>
       <th width="110" class="txtleft">&nbsp;</th>
       </tr>
 <?list?>
     </table>
   </div>
