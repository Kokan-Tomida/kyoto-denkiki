  ...
  <div id="contents_box">
   ...
   <div class="left btn01_on"><a href="a4110.php">貸出履歴</a></div>
   ...
   <div id="search_box02">
   <form method="post" action="a4110.php" name="frm" onKeyPress="setOnEnterClickButton('to_search','frm');">
   ...
   <div class="tbbg01">
    ...
    <tr>
       <th width="26">No</th>
       <th width="93" class="txtleft">申請日</th>
       <th width="107" class="txtleft">法人名</th>
       <th width="66" class="txtleft">ご担当者名</th>
       <th width="166" class="txtleft">照明</th>
       <th width="115" class="txtleft">電源</th>
       <th width="108" class="txtleft">対象物ワーク</th>
       <th width="110" class="txtleft">履歴備考</th>
     </tr>
     <?list?>
     </table>
   </div>
