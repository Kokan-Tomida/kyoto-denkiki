  ...
  <div id="contents_box">
   ...
   <div class="tbbg01">
    <table width="960" border="0" cellspacing="1" cellpadding="10">
     <tr>
       <th width="28">No</th>
       <th width="119" class="txtleft">問合せ日</th>
       <th width="148" class="txtleft">法人名</th>
       <th width="96" class="txtleft">ご担当者名</th>
       <th width="100" class="txtleft">電話番号</th>
       <th width="211" class="txtleft">問合せ種別</th>
