  ...
  <div id="contents_box">
   ...
   <div class="left btn01_on"><a href="a4130.php">ログイン履歴</a></div>
   <div class="left btn01"><a href="a4140.php">ダウンロード履歴</a></div>
   </div>
   
   <div id="search_box02">
   <form method="post" action="a4130.php" name="frm" onKeyPress="setOnEnterClickButton('to_search','frm');">
   ...
   <div class="tbbg01">
    <table width="960" border="0" cellspacing="1" cellpadding="10">
     <tr>
       <th width="29">No</th>
       <th width="120" class="txtleft">ログイン日時</th>
       <th width="120" class="txtleft">アンケート項目</th>
       <th width="180" class="txtleft">法人名</th>
       <th width="180" class="txtleft">ご担当者名</th>
