...
class a4110 extends Base{
	...
	private function _list($all = false){
		...
		$fld = 'H.id,H.generate_date,H.generate_time,H.kdn_member_id,M.company_name,M.charge_name,M.pref,H.note1,H.note2,H.note3,H.history_id,H.history_admin_note';
