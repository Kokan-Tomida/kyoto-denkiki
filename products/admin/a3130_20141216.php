...
class a3130 extends Base{
	...
	private function _list($all = false){
		...
		$fld = 'H.id, H.type, H.kdn_member_id, M.company_name, M.charge_name, H.generate_date, H.generate_time, H.note1, H.note2, H.note3, H.history_id ';
