...
---------------------------------------------------------------------*/
	...
	require_once($root.'/admin_test/include/env/env.inc');
	require_once($root.'/admin_test/include/const/constant3.inc');
	$r = require_once($root.'/admin_test/include/const/cron.inc');
	if(!$r)		exit;
