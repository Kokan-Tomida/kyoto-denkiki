...
$temp_html = array(
	'config'		=> 'sample_config.php' // 基本設定
,	'form'			=> 'sample_form.html' // 入力フォーム用
,	'confirm'		=> 'sample_confirm.html' // 確認画面用
,	'completion'	=> 'sample_completion.html' // 送信完了画面
,	'mail'			=> 'sample_mail_tmpl.php' // メール送信用
,	'reply'			=> 'sample_reply_tmpl.php' // 自動返信メール用
);
