...
$this->set_link();
	...
	private function _getConstruct($table){
		...
		while($row = $this->m_objDB->getResult()->fetch(PDO::FETCH_ASSOC)){
			$construct[] = $row;
		}
		return $construct;
	}
...
/*
				if((aexists('1',$questionnaire)) and (aexists2('1','1', $G_QUESTIONNAIRE))){
				$a1 = $G_QUESTIONNAIRE['1']['1'][$questionnaire['1']];
			}
			if((aexists('2',$questionnaire)) and (aexists2('2','1', $G_QUESTIONNAIRE))){
				$a2 = $G_QUESTIONNAIRE['2']['1'][$questionnaire['2']];
			}
*/
			}
		}
