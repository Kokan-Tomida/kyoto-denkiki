  ...
  <div id="subheader_box">
   ...
   <div id="subcontents_box">
    ...
    <h2 class="mg-top11 mg-bottom23"><img src="images/titlebar.gif" alt="ダウンロードコンテンツ" width="960" height="42" /></h2>
     ...
     <p class="fs14 pd-bottom36"><strong>オプトエレクトロニクス製品では、取扱説明書や外形図のPDF、もしくはDXFファイルなどをご利用いただけます。<br />まずは<a href="<?member_login_url?>">こちら</a>で会員登録（無償）を行って下さい。<br />既に会員アカウントをお持ちの方は下記よりログインしてお申し込み下さい。</strong></p>
