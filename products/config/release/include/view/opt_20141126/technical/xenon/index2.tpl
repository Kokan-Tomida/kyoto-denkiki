  ...
  <div id="subheader_box">
   ...
   <div id="subcontents_box">
    ...
    <div id="t_x_box02">
     ...
     <div class="left pd-left247"><a href="index.php"><img src="images/btn01_off.gif" alt="制御信号について" width="232" height="67" /></a></div>
     <div class="left"><img src="images/btn02.gif" alt="用語説明" width="233" height="67" /></div>
    </div>

    <h3 class="mg-top30"><img src="images/subtitle02.gif" alt="用語説明" width="191" height="32" /></h3>
    <div class="clearfix">
     <div class="left"><a href="#l04"><img src="images/btn06_off.gif" alt="電気性能" width="173" height="65" /></a></div>
     <div class="left"><a href="#l05"><img src="images/btn07_off.gif" alt="ランプ性能" width="787" height="65" /></a></div>
    </div>

    <div class="technical_led_box03">

     <div class="clearfix">
      <div class="left wd-383">
       <div id="l04"><img src="images/text01.gif" alt="電気性能" width="80" height="19" /></div>
       <div class="xenon_text01 mg-top15">発光エネルギー</div>
       <p class="mg-top5">キセノンフラッシュランプの１フラッシュ当たりの入力エネルギーのことです。単位は、J/F（Jule Per Flash）で表し、次式で計算できます。<br /><br />J=1/2×C×V2<br />C：出力コンデンサ容量（μF）<br />V：ランプ印加電圧（Ｖ）</p>
       <div class="xenon_text01 mg-top16">出力電力</div>
       <p class="mg-top5">キセノンフラッシュランプが１秒間に消費する電力量のことです。通常電源の大きさは、この電力量で表現されます。単位は、W（Watt)で表し、次式で計算できます。<br /><br />
W=J×f=1/2×C×V2×f<br /><br />
この式内の f は、繰り返し周波数（単位：Ｈz)で、キセノンフラッシュランプが１秒間に許容される発光周波数のことです。周波数と光量の関係は下図のようになります。</p>
      </div>
      <div class="right wd-482">
       <div><img src="images/text02.gif" alt="Electrical performance" width="205" height="16" /></div>
       <div class="xenon_text01 mg-top18">Emission energy</div>
       <p class="mg-top5">Emission energy refers to input energy to a xenon flash lamp per flash. <br />The following formula is used to calculate emission energy in J/F <br />(Jule Per Flash).<br /><br />
J=1/2×C×V2<br />C: Capacitance of output capacitor (μF)<br />V: Lamp applied voltage (V)</p>
       <div class="xenon_text01 mg-top16">Emission energy</div>
       <p class="mg-top5">Output power refers to power consumption of xenon flash lamp per second. The capacity of a normal power supply is expressed in output power. The following formula is used to calculate output power in W (Watt).<br /><br />
W = J × f = 1/2 × C × V2 × f<br /><br />
In the above formula, f refers to repetition frequency (in Hz), i.e., the permissible emission frequency of the xenon flash lamp per second.
Frequency and light intensity have the following relationship.
</p>
      </div>
     </div>

     <div class="clearfix mg-top31">
      <div class="left"><img src="images/item09.jpg" alt="出力電力：15W固定" width="440" height="167" /></div>
      <div class="right wd-430">

      <div class="tablebg02">
      <table width="430" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="150" class="cell03"><div class="pd-left10 pd-top8 pd-bottom7"><strong>繰り返し周波数</strong><p class="pd-top3">Repetition frequency
</p></div></td>
          <td width="138" colspan="2" class="txtcenter">100Hz type</td>
          <td width="138" class="txtcenter">20Hz type</td>
        </tr>
        <tr>
          <td width="150" class="cell03"><div class="pd-left10 pd-top8 pd-bottom7"><strong>出力</strong><p class="pd-top3">Output</p></div></td>
          <td width="277" colspan="3" class="txtcenter">15W</td>
        </tr>
        <tr>
          <td width="150" class="cell03"><div class="pd-left10 pd-top8 pd-bottom7"><strong>発光エネルギー</strong><p class="pd-top3">Emission energy</p></div></td>
          <td width="138" colspan="2" class="txtcenter">0.15J/F</td>
          <td width="138" class="txtcenter">0.75J/F</td>
        </tr>
        </table>
      </div>
...
<div class="technical_led_box03">
     ...
     <div class="clearfix">
      <div class="left wd-383">
       <div id="l05"><img src="images/text03.gif" alt="ランプ性能" width="98" height="20" /></div>
       <div class="xenon_text01 mg-top15">閃光時間</div>
       <p class="mg-top5">ストロボの閃光時間は、一般的に半値幅で規定されます。<br />
         （半値幅とは、閃光光量の1/2の時間幅のことをいいます）<br />
         通常、数μsec～数十μsecです。<br />図1中のT1のことです。<br /><br />
         <strong>閃光時間が短くなる条件</strong><br />
         ・ランプ印加電圧が高い　<br />
         ・出力コンデンサ容量が小さい<br />
         ・ランプ電極間が短い<br />
         ・ランプハウスケーブルが短い<br />
       </p>
       <div class="xenon_text01 mg-top16">ジッター</div>
       <p class="mg-top5">ジッターとは、発光毎のトリガ信号に対する遅延時間の変動のことをいいます。通常、数百nsec～数μsecです。ジッター時間は、ランプの種類、放電管入力エネルギー、発光周波数により異なります。図1中のT2のことです。</p>
       <div class="xenon_text01 mg-top16">遅延時間</div>
       <p class="mg-top5">トリガ信号を入力して実際にランプが点灯するまでの遅れ時間のことをいいます。通常、数μsec～数十μsecです。<br />図中のT3のことです。</p>
       <div class="xenon_text01 mg-top16">安定性</div>
       <p class="mg-top5">ランプハウス等の仕様書内に記載されています安定性とは、キセノンフラッシュランプが同一エネルギーで点灯する毎の光の安定性のことをいいます。</p>

      </div>
      <div class="right wd-482">
       <div><img src="images/text04.gif" alt="Lamp performance" width="167" height="16" /></div>
       <div class="xenon_text01 mg-top18"> Flash time</div>
       <p class="mg-top5">Half width is usually used to specify strobe flash time. (The half width of flash time refers to a period the flash light intensity reaches 1/2 of the full flash light intensity.) Usual half-width time is several to several tens of microseconds (T1 in figure 1).<br /><br />
         <strong>Conditions contracting flash time</strong><br />
         窶｢ The lamp applied voltage is high.<br />
         窶｢ The capacitance of the output capacitor is low.<br />
         窶｢ The distance between lamp electrodes is short.<br />
         窶｢ The lamp house cable is short.</p>
       <div class="xenon_text01 mg-top16">Jitter</div>
       <p class="mg-top5">Jitter time refers to the fluctuation of delay time in response to the trigger signal per flash. Usual jitter time is several to several hundreds of microseconds. Jitter time varies with the type of lamp, input energy into the discharge tube, and emission frequency (T2 in figure 1).</p>
       <div class="xenon_text01 mg-top16">Delay time</div>
       <p class="mg-top5">Delay time refers to a time lag between the time actual trigger signal input is ON and the time the lamp is lit.Usual delay time is several to several tens of microseconds.(T3 in figure 1).</p>
       <div class="xenon_text01 mg-top16">Stability</div>
       <p class="mg-top5">The light intensity stability of a xenon flash lamp specified in the specification sheets of products, such as lamp housings, refers to the stability of light emitted by the xenon flash lamp supplied with the same energy (provided that the life of the xenon flash lamp is not expired).<br />
       </p>
      </div>
     </div>

     <div class="clearfix mg-top36">
      <div class="left wd-411">
       <div><img src="images/item10.gif" alt="図1" width="411" height="289" /></div>
       <p class="mg-top7 txtcenter">図1</p>
      </div>
      <div class="right wd-460">
       <div><img src="images/item11.gif" alt="図2  放射スペクトル分布" width="460" height="289" /></div>
       <p class="mg-top7 txtcenter">図2  放射スペクトル分布</p>
      </div>
     </div>
