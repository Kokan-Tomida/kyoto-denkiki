...
<body>
 ...
 <div id="subwrapper">
  ...
  <div id="subheader_box">
   ...
   <div id="pankuzu"><a href="../../index.php">TOP</a> &gt; 蛍光灯技術資料</div>
   <!-- InstanceEndEditable -->
   ...
   <div id="subcontents_box">
    ...
    <h2 class="mg-top11"><img src="images/titlebar.gif" alt="蛍光灯技術資料　Fluorescnt Lamps Technical document" width="960" height="42" /></h2>

    <div id="t_l_box01">

    <div class="clearfix mg-top35">
     <div class="left"><a href="#l01"><img src="images/btn01_off.gif" alt="LED照明を長くご使用いただくために" width="197" height="65" /></a></div>
     <div class="left"><a href="#l02"><img src="images/btn02_off.gif" alt="LED照明の劣化について" width="221" height="65" /></a></div>
     <div class="left"><a href="#l03"><img src="images/btn03_off.gif" alt="使用環境による明るさの変化" width="208" height="65" /></a></div>
     <div class="left"><a href="#l04"><img src="images/btn04_off.gif" alt="使用環境による明るさの変化" width="334" height="65" /></a></div>
    </div>

    <div class="technical_led_box01">
     <div class="clearfix">
      <div class="left wd-340">
      <p id="l01" class="technical_text03">定電流運転</p>
      <p class="mg-top11">蛍光灯はガラス管内部に放電電流が流れる事で点灯し、この放電電流が変動すれば、蛍光灯の光量も変動します。定電流運転とは、放電電流を一定に流し、点灯させる方式を指します。<br />これにより、画像処理用照明に求められる安定した光量が得られます。</p>
      </div>
      <div class="left wd-500 pd-left35">
       <p class="technical_text04">Constant current operation</p>
       <p class="mg-top11">A fluorescent lamp will be lit when a discharge current flows through the glass tube. The light intensity of the fluorescent lamp varies with the change of the discharge current. <br />
         A fluorescent lamp in constant current operation is lit with a constant discharge current flown. <br />
         This provides a stable level of light intensity required for image processing.</p>
      </div>
     </div>

     <div class="technical_flu_box01 clearfix">
      <div class="left pd-top192 pd-left20">
      <table width="390" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td width="92">ランプハウス</td>
          <td width="90">Lamp House</td>
          <td width="92">ULSTシリーズ</td>
          <td width="84">ULST series</td>
        </tr>
        <tr>
          <td>LSTシリーズ</td>
          <td>LST series</td>
      ...
      <div class="left pd-left104 pd-top10">
       <p>点灯ケーブル　Lighting cable<br />HF-NEG-□M/PN</p>
       <p class="technical_space">点灯ケーブル　Lighting cable<br />HF-NEG-□M/PN</p>
      </div>
     </div>
    ...
    <div class="technical_led_box01">
     <div class="clearfix">
      <div class="left wd-340">
      <p id="l02" class="technical_text03">光量一定運転<img src="images/item02.gif" width="48" height="37" class="icotext-bottom pd-left5" /></p>
      <p class="mg-top11">定電流運転で光量を安定させていても、蛍光灯は経年変化や周囲温度変化により光量変動が発生します。<br />
        光量一定運転は、光量センサーから光量を取り込み、変動した光量を補正します。<br />
        これにより、一段と安定した光量を得られます。<br />
        定電流運転よりも安定した光量を求められる場合に、お勧め致します。</p>
      </div>
      <div class="left wd-500 pd-left35">
       <p class="technical_text04">Constant light intensity control</p>
       <p class="mg-top11">The light intensity of a fluorescent lamp will fluctuate as a result of secular changes and ambient temperature changes even if the fluorescent lamp is in constant current operation. <br />
         A light sensor compensates the fluctuated light intensity of the fluorescent lamp under constant light intensity control. <br />
         This will ensure a stable level of light intensity. <br />
         This is recommended if the fluorescent lamp requires a stable level of light intensity rather than constant current control.</p>
      </div>
     </div>

     <div class="technical_flu_box02 clearfix">
      <div class="left pd-top287 pd-left20">
      <table width="390" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td>ランプハウス</td>
          <td colspan="2">Lamp House</td>
        </tr>
        <tr>
          <td>LST（SN1）シリーズ</td>
          <td colspan="2">LST(SN1) series</td>
        </tr>
        <tr>
          <td>LSTS（SN1）シリーズ</td>
          <td colspan="2">LSTS(SN1) series</td>
        </tr>
        <tr>
          <td width="170">ULST（SN1）シリーズ</td>
          <td width="204" colspan="2">ULST(SN1) series</td>
          </tr>
        <tr>
          <td>HLST（SN1）シリーズ</td>
          <td>HLST(SN1) series</td>
        </tr>
        </table>
      </div>
      <div class="left pd-left104 pd-top20">
       <p>点灯ケーブル　Lighting cable<br />HF-NEG-□M/PN</p>
       <p class="technical_space02">調光ケーブル　Dimming cable<br />SN1-HAS-□M/PHS　SN1-HAS-□M/PPM</p>
       <p class="technical_space03">調光ケーブル　Dimming cable<br />SN1-HAS-□M/PHS　SN1-HAS-□M/PPM</p>
      </div>
     </div>
    ...
    <div class="technical_led_box01">
     ...
     <div class="clearfix">
      <div class="left">
      <p id="l03" class="technical_text03">リモートコントロール</p>
      <p class="mg-top11">点灯電源より離れた場所からのコントロールが可能</p>
      </div>
      <div class="left pd-left40">
       <p class="technical_text04">Remote control</p>
       <p class="mg-top11">The remote control of lighting power supply is possible.</p>
      </div>
     </div>

     <div class="technical_flu_box03">

      <div class="clearfix">
       <div class="left"><img src="images/item04.gif" alt="0-5V 外部調光" width="233" height="45" /></div>
       <div class="left pd-left15 pd-top5">0～5V信号での調光（INPUT）<br />0- to 5-V signal dimming.</div>
      </div>

      <div class="clearfix mg-top10">
       <div class="left"><img src="images/item05.gif" alt="on/off 外部ON/OFF" width="233" height="45" /></div>
       <div class="left pd-left15">接点一つで点灯／消灯をコントロール（INPUT）<br />A contact in ON/OFF lighting control. <br /><span class="fs10">(Open collector singnal. "LOW" level "OFF")</span></div>
      </div>

      <div class="clearfix mg-top10">
       <div class="left"><img src="images/item06.gif" alt="CUR. 管電流モニター" width="233" height="45" /></div>
       <div class="left pd-left15 pd-top5">蛍光灯の電流をモニター（OUTPUT）<br />Monitoring the flow currents of fluorescent lamps.</div>
      </div>

      <div class="clearfix mg-top10">
       <div class="left"><img src="images/item07.gif" alt="RAD. 光量モニター" width="233" height="45" /></div>
       <div class="left pd-left15 pd-top5">蛍光灯の光量をモニター（OUTPUT）<br /> Monitoring the light intensity of fluorescent lamps.</div>
      </div>

      <div class="clearfix mg-top10">
       <div class="left pd-left63"><img src="images/item08.gif" alt="5V基準電圧" width="170" height="45" /></div>
       <div class="left pd-left15 pd-top5">外部調光0縲鰀5Vの電源として使用可能（OUTPUT）<br />Available as 0- to 5-V power supply for external dimming.</div>
      </div>

      <div class="clearfix mg-top10">
       <div class="left pd-left63"><img src="images/item09.gif" alt="点灯信号" width="170" height="45" /></div>
       <div class="left pd-left15">蛍光灯の点灯状態（点灯／消灯）を信号にてお知らせ<br />This signal informs the ON/OFF lighting control of fluorescent lamps.<br /><span class="fs10">(Open collector singnal. Light "LOW" signal output.)</span></div>
      </div>

      <div class="clearfix mg-top10">
       <div class="left pd-left63"><img src="images/item10.gif" alt="制御量飽和信号" width="170" height="46" /></div>
       <div class="left pd-left15">蛍光灯の光量低下を信号にてお知らせ<br />This signal informs the light intensity level reduction of fluorescent lamps.<br /><span class="fs10">(Open collector singnal. Saturation "LOW" signal output.)</span></div>
      </div>

      <div class="clearfix mg-top10">
       <div class="left pd-left63"><img src="images/item11.gif" alt="警報信号" width="170" height="45" /></div>
       <div class="left pd-left15">蛍光灯の点灯不良を信号にてお知らせ<br />This signal informs lighting failures in fluorescent lamps.<br /><span class="fs10">(Open collector singnal. Abnormal "LOW" signal output.)</span></div>
      </div>

     </div>

     <div class="technical_flu_box04">
      <p>RS232C、RS485通信による簡易コントロール<br />Simple control over RS-232C and<br />RS-485 communication.</p>
      <p class="technical_space04">256階調の詳細調光<br />256-gradient precise dimming.</p>
     </div>
    ...
    <div class="technical_led_box01">
     ...
     <div class="clearfix">
      <div class="left">
      <p id="l04" class="technical_text03">多灯システム</p>
      <p class="mg-top11">蛍光灯を複数点灯させる場合の効果的な機能</p>
      </div>
      <div class="left pd-left40">
       <p class="technical_text04">Multi-lighting systems</p>
       <p class="mg-top11">An effective function to turn ON a number of fluorescent lamps.</p>
      </div>
     </div>

     <div class="clearfix mg-top36">
       <div class="left"><img src="images/item14.gif" alt="RATIO 比例制御運転" width="233" height="46" /></div>
       <div class="left pd-left15">電源1台の調光信号で複数台同時調光が可能であり、効率的<br />A diming signal from a single power supply is in effective dimming control of a number of<br />fluorescent lamps simultaneously.</div>
      </div>

     <div class="clearfix mg-top10">
       <div class="left"><img src="images/item15.gif" alt="SYNC 同期運転" width="233" height="46" /></div>
       <div class="left pd-left15">蛍光灯への電流（高周波正弦波）を同期させる事により相互干渉が軽減され、より安定化<br />Synchronizing the flow current of fluorescent lamps to mitigate mutual interference and<br />stabilize the lighting of the fluorescent lamps.</div>
      </div>

      <div class="mg-top36"><img src="images/item16.jpg" alt="多灯システム" width="898" height="290" /></div>
   ...
   <div id="footer_box">
    ...
    <div id="footer" class="clearfix">
     ...
     <div class="right wd-240 mg-top30">
      ...
      <p class="f_space09 mg-left18"><img src="../../common/images/ico03.gif" width="6" height="12" class="icotext-middle pd-right5" /><strong><a href="index.php">蛍光灯技術資料</a></strong></p>
