  ...
  <div id="subheader_box">
   ...
   <div id="subcontents_box">
    ...
    <div class="clearfix mg-top25">
     <div class="left pd-left132"><img src="images/btn01.gif" alt="LED素子の特性について" width="232" height="67" /></div>
     <div class="left"><a href="index2.php"><img src="images/btn02_off.gif" alt="点灯電源の調光について" width="230" height="67" /></a></div>
     <div class="left"><a href="index3.php"><img src="images/btn03_off.gif" alt="点灯電源の選定・I/O回路の機能説明" width="233" height="67" /></a></div>
    </div>

    <h3 class="mg-top30"><img src="images/subtitle.gif" alt="LED素子の特性について" width="271" height="32" /></h3>
    <div class="clearfix">
     <div class="left"><a href="#l01"><img src="images/btn04_off.gif" alt="LED照明を長くご使用いただくために" width="316" height="65" /></a></div>
     <div class="left"><a href="#l02"><img src="images/btn05_off.gif" alt="LED照明の劣化について" width="241" height="65" /></a></div>
     <div class="left"><a href="#l03"><img src="images/btn06_off.gif" alt="使用環境による明るさの変化" width="403" height="65" /></a></div>
    </div>

    <div class="technical_led_box01">
     <p id="l01" class="technical_text01">LED照明を長くご使用いただくために</p>
     <p class="mg-top11">LED照明は素子自身を放熱することで劣化を遅らせ、長寿命で使用することが可能です。LED素子の寿命は、20,000時間くらいといわれています。<br />LED素子の寿命の要因には、オープンやショートによる破壊、樹脂レンズの劣化があり、全ての起因は熱によるものです。<br />そのためLED照明を長くご使用いただくため下記の熱対策を推奨します。</p>

     <div class="technical_led_box02">
      <div class="clearfix">
       <div class="left wd-265">
        <p class="fs14"><strong>LED照明の筐体熱を下げる</strong></p>
        <p class="mg-top7">LED照明を取り付けてご使用になる場合、金属ブラケットや金属部品をご使用いただくかエア等で冷却して使用いただくことをお勧めします。LED素子は、他の照明と異なり赤外放射がありません。そのため伝導、対流にて放熱をさせる必要があります。</p>
       </div>
       <div class="left pd-left15 pd-right15"><img src="images/line.gif" width="1" class="l_h01" /></div>
       <div class="left wd-265">
        <p class="fs14"><strong>こまめにON/OFFして<br />不要な時は消灯する</strong></p>
        <p class="mg-top7">LED照明は、消灯→点灯させても明るさが安定していますので必要のない時は出来る限り消灯させて下さい。発熱を抑え素子に掛かる熱ストレスが低減され素子の劣化を遅らせることができます。</p>
       </div>
       <div class="left pd-left15 pd-right15"><img src="images/line.gif" width="1" class="l_h01" /></div>
       <div class="left wd-266">
        <p class="fs14"><strong>光量は低めでご使用ください</strong></p>
        <p class="mg-top7">光量を下げることで素子の発熱を抑えることができます。光量を下げるため下記項目を推奨します。</p>
        <ol>
         <li>ワークまでの距離を近づける。</li>
         <li>カメラのシャッターSPを長くし取り込み量を多くする。</li>
         <li>出来る限り明るい照明を使用する。</li>
        </ol>
       </div>
      </div>
     </div>

     <p class="technical_text02 mg-top34">To use LED lighting long</p>
     <p class="mg-top11">As explained above, the element degradation of LED lighting may be retarded by dissipating the heat generation of the elements for the long-time use of the LED lighting. An LED element is said to have a life of approximately 20,000 hours. The long-time use of LED lighting depends on how the element life can be prolonged. The implementation of the following items are recommended so that LED lighting can be used for a long time.</p>

     <div class="technical_led_box02">
      <div class="clearfix">
       <div class="left wd-265">
        <p class="fs14"><strong>Lowering the housing<br />temperature of LED lighting</strong></p>
        <p class="mg-top7">When installing LED lighting, use metal mounting brackets or parts so that the heat of the lighting will be dissipated as much as possible.<br />Use LED lighting in good ventilation environments.<br />The use of thermal conductive sheets will provide more efficient heat dissipation.</p>
       </div>
       <div class="left pd-left15 pd-right15"><img src="images/line02.gif" width="1" class="l_h02" /></div>
       <div class="left wd-265">
        <p class="fs14"><strong>こまめにON/OFFして<br />不要な時は消灯する</strong></p>
        <p class="mg-top7">The brightness of LED lighting is stable regardless of the frequency of ON/OFF times. The brightness of LED lighting is stable regardless of the frequency of the ON/OFF operation. Be sure to turn OFF LED lighting as much as possible whenever the LED lighting is unnecessary. This will suppress the generation of heat and reduce the thermal stress on the elements, thus making it possible to retard the element degradation of the LED lighting.
</p>
       </div>
       <div class="left pd-left15 pd-right15"><img src="images/line02.gif" width="1" class="l_h02" /></div>
       <div class="left wd-266">
        <p class="fs14"><strong>Lower the light intensity of LED<br />lighting as much as possible.</strong></p>
        <p class="mg-top7">The heat radiation of the elements can be suppressed by lowering the light intensity. The implementation of the following items are recommended to lower the light intensity.</p>
        <ol>
         <li>Shorten the distance between the lighting source and workpieces.</li>
         <li>Prolong the shutter speed of the camera to increase the capture quantity of light.</li>
         <li>Use a light source as bright as possible.Setting the light intensity to a lower value will provide the light source with a sufficient margin to increase the light intensity.</li>
        </ol>
       </div>
      </div>
     </div>
   ...
   <div class="technical_led_box03">
     ...
     <div class="clearfix">
      <div class="left wd-390">
      <p id="l02" class="technical_text01">LED照明の劣化について</p>
      <p class="mg-top11">LED素子は、寿命が長いとよく言われていますが光量は徐々に低下していきます。<br />
下記は当社標準照明の光量劣化データ（参考データ）です。<br />
（常温にて光量：MAXで連続点灯させた場合のデータ）</p>
      <p class="technical_text02 mg-top28">Life of LED lighting</p>
      <p class="mg-top11">An LED element is said to have a long life, but the life may become very short depending on the handling of the LED element. The following graph shows data on the light intensity degradation of our standard lighting (reference data). (Data on the condition that the LED is lit at its maximum light intensity continuously at normal temperature.)</p>
      <p class="mg-top28">※右記データは、参考データです。<br />　性能を保証するものではありません。<br />　KDDR2-90/50Wのデータです。<br />
※ The above data is reference data. The data does not<br />
&nbsp;&nbsp;&nbsp;&nbsp;guarantee the performance of the models.<br />&nbsp;&nbsp;&nbsp;&nbsp;KDDR2-90/50W used.</p>
      </div>
      <div class="right"><img src="images/item01.gif" alt="光量劣化データ" width="479" height="355" /></div>
     </div>
    ...
    <div class="technical_led_box03">
     ...
     <div class="clearfix">
      <div class="left wd-353">
      <p id="l03" class="technical_text01">使用環境による明るさの変化</p>
      <p class="mg-top11">LED照明は、周囲環境で明るさに変化が現れます。LED照明は下記の使用環境でご使用いただけることを推奨します。
周囲温度と明るさの関係について下記グラフを参考にして下さい。</p>

      <div class="technical_led_box04">
       <p>使用環境：屋内<br />Operating environment: Indoors</p>
       <p class="mg-top11">使用温度：0～40℃<br />Operating temperature: 0℃ to 40℃</p>
       <p class="mg-top11">使用湿度：30～85%R.H.（no condensation）<br />Operating humidity: 30% to 85% R.H. <br />(no condensation)</p>
      </div>

      </div>
      <div class="right wd-510">
       <p class="technical_text02">Change of brightness according to <br />operating environment</p>
       <p class="mg-top11">The brightness of LED lighting varies according to the ambient conditions. The use of LED lighting in the following operating environment is recommended. Refer to the following graph for the relationship between the ambient temperature and brightness.</p>
       <p class="mg-top18">LED照明は、他の照明に比べ点灯開始からの明るさが安定しているといわれます。しかし、厳密には点灯開始からの数分間は明るさが変化しています。</p>
       <p class="mg-top8">Compared with the brightness of other types of lighting, the brightness of LED lighting is said to be stable from the moment the LED lighting is turned ON. Strictly speaking, the brightness of LED lighting changes for a few minutes after the moment the LED lighting is turned ON. Compared with other types of lighting, the required time of LED lighting until its brightness is stabilized is short.
</p>
      </div>
     </div>

     <div class="clearfix mg-top40">
      <div class="left wd-431">
       <div><img src="images/item02.gif" alt="周囲温度-明るさ変化" width="431" height="349" /></div>
       <p class="mg-top18">※周囲温度25℃を100%として表示<br />
※上記データは、参考データです。性能を保証するものではありません。<br />
※The above graph is shown on the condition that an ambient<br />
&nbsp;&nbsp;&nbsp;temperature of 25℃ is 100%. <br />
※The above data is reference data. The data does not<br />
&nbsp;&nbsp;&nbsp;guarantee the performance of the models.</p>
      </div>
      <div class="right wd-433">
       <div><img src="images/item03.gif" alt="経過時間による明るさの変化" width="433" height="349" /></div>
       <p class="mg-top18">※周囲温度は25℃です。 <br />
         ※上記データは、説明用のイメージデータです。<br />&nbsp;&nbsp;&nbsp;性能を保証するものではありません。<br />
※The ambient temperature is 25℃. <br />
※The above data is reference data for illustration purpose. The <br />&nbsp;&nbsp;&nbsp;data does not  guarantee  the performance of the models.<br />
       </p>
      </div>
     </div>
