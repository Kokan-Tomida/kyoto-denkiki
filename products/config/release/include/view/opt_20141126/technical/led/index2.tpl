   ...
   <div id="subcontents_box">
    ...
    <div id="t_l_box02">
     <div class="clearfix mg-top25">
          ...
          <div class="left"><img src="images/btn02.gif" alt="点灯電源の調光について" width="230" height="67" /></div>
          <div class="left"><a href="index3.php"><img src="images/btn03_off.gif" alt="点灯電源の選定・I/O回路の機能説明" width="233" height="67" /></a></div>
         </div>

    <h3 class="mg-top30"><img src="images/subtitle02.gif" alt="点灯電源の調光について" width="271" height="32" /></h3>
    <div class="clearfix">
     <div class="left"><a href="#l04"><img src="images/btn07_off.gif" alt="点灯電源の調光機能について" width="316" height="65" /></a></div>
     <div class="left"><a href="#l05"><img src="images/btn08_off.gif" alt="点灯電源の調光方式について" width="644" height="65" /></a></div>
    </div>

    <div class="technical_led_box03">

     <div class="clearfix">
      <div class="left wd-330">
      <p id="l04" class="technical_text01">点灯電源の調光機能について</p>
      <p class="mg-top11">当社の点灯電源の調光機能としては、電源本体が内部に持つ調光機能とお客様装置から信号を入力する調光機能とがあります。<br />調光機能については、以下の通りです。</p>
      </div>
      <div class="right wd-525">
       <p class="technical_text02">Dimming Function of Lighting Power Supply</p>
       <p class="mg-top11">Kyoto Denkiki's lighting power supplies are provided with a function supporting two types of dimming, i.e., internal dimming, which is a built-in feature, and external dimming under the control of signal input from customers' devices. The following figure shows the outline of the dimming function.</p>
      </div>
     </div>

     <div class="clearfix mg-top36">
      <div class="left wd-539">
       <div><img src="images/item04.gif" width="539" height="453" /></div>
       <div class="technical_led_box05">
        <p>※左のグラフは、電源側<br />　の出力可変になります。<br />　照明側の出力可変では<br />　ありません。</p>
        <p class="pd-left10 pd-top13">The above graph shows the variable output on the power supply side, and power on the lighting side is not variable.<br />
        </p>
       </div>
       <p class="mg-top18">
       ※調光機能については、点灯電源により仕様が異なりますのでご使用になる前にご確認下さい。<br />
※通信仕様は、オプション扱いです。<br />　通信仕様については、点灯電源の個別仕様によりますのでお問い合わせ下さい。<br />
※The specifications of the dimming function vary with each lighting power supply.<br />
&nbsp;&nbsp;&nbsp;Check the specifications of your lighting power supply before use.<br />
※The communications specifications are optional.The specifications of<br />
&nbsp;&nbsp;&nbsp;communication vary with each lighting  power supply. For details, contact<br />
&nbsp;&nbsp;&nbsp;Kyoto Denkiki.
       </p>
      </div>
      <div class="right wd-345">
       <p><strong>a）内部調光  Internal dimming</strong><br />前面パネル部操作による調光機能<br />
電源ごとに、RSW(ロータリースイッチ)、パネルSW、VRと種類は異なりますが、出力を0-100%まで可変することができます。<br />Dimming through the operation of the front panel<br />The output is variable between 0% and 100% with a built-in component, such as a rotary switch (RSW), panel switch (SW), or a variable resistor (VR), depending on the power supply model.</p>
<p class="mg-top13"><strong>b）外部調光  External dimming</strong><br />お客様の装置等から信号を受けて調光する機能として下記のものがあります。</p>
        <ol>
         <li>アナログ信号（0-5V信号)による調光機能<br />外部より0-5Vの電圧信号を入力することで0-100%まで出力を可変することができます。<br />印加電圧と出力は左のグラフのような関係があります。<br />（グラフはFig.1参照）</li>
         <li class="pd-top8">デジタル信号（8bit信号）による調光機能<br />外部より8bit（256階調）の信号を入力することで0-100%まで出力を可変することができます。</li>
         <li class="pd-top8">デジタル信号（10bit信号）による調光機能<br />外部より10bit（1024階調）の信号を入力することで0-100%まで出力を可変することができます。</li>
         <li class="pd-top8">シリアル通信（RS-232C）による調光機能</li>
         <li class="pd-top8">シリアル通信（RS-485）による調光機能</li>
         <li class="pd-top8">LAN通信による調光機能</li>
        </ol>
        <p class="mg-top23">The following types of signals from customers' devices are used for dimming control.</p>
        <ol>
         <li>Analog signal (at 0 to 5 V)<br />The output is variable between 0% and 100% with external voltage signal input at 0 to 5 V.<br />The output and applied voltage has a relationship shown in the graph (see fig. 1) on the left-hand side.</li>
         <li class="pd-top8">8-bit digital signal<br />The output is variable between 0% and 100% with 8-bit (256-level gradient) external signal input.</li>
         <li class="pd-top8">10-bit digital signal<br />The output is variable between 0% and 100% with 10-bit (1024-level gradient) external signal input.</li>
         <li class="pd-top8">RS-232C serial communication</li>
         <li class="pd-top8">RS-485 serial communication</li>
         <li class="pd-top8">LAN communication</li>
        </ol>
      </div>
     </div>
...
<div class="technical_led_box03">
     ...
     <div class="clearfix">
      <div class="left wd-330">
      <p id="l05" class="technical_text01">点灯電源の調光方式について</p>
      <p class="mg-top11">LEDの明るさを調整するのに一般的な方法としてLEDに流れる電流を可変することが知られています。LEDに流す電流と明るさはほぼ比例関係にあります。<br />（但し、一部LEDでは電流を多く流した時に発光効率が下がり比例関係が崩れることがあります。）<br />
      </p>
      </div>
      <div class="right wd-525">
       <p class="technical_text02">Dimming of LED lighting</p>
       <p class="mg-top11">It is known as a common way to adjust the brightness of LEDs by varying current flowing into the LEDs. The brightness of the LED increases almost in proportion to the level of the current flowing into the LED. (Some LEDs, however, may not be able to maintain the proportional relationship with a fall of luminous efficiency when a high driving current flows into the LEDs.)</p>
      </div>
     </div>

     <div class="clearfix mg-top46">
      <div class="left wd-375">
       <p>a）定電流制御による調光<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dimming under constant current control.</p>
       <p class="mg-top18">LEDに流す電流を一定にしてその電流値を可変して調光する方式。<br />
ラインセンサーカメラ用の照明を点灯させる時にはノイズ成分が少なくなる等のメリットがある。<br />
電流調光のため、LED素子に依っては電流値によって色味が変化する可能性があります。</p>
       <p class="mg-top18">In this method, an LED is dimmed by varying the constant current level. This method provides benefits, such as a reduction in noise, in the case of using the LED as an illumination lamp for a line sensor camera. The tint of the LED may vary with the current, depending on the element type of the LED.</p>
      </div>
      <div class="right"><img src="images/item06.gif" alt="定電流制御による調光" width="471" height="349" /></div>
     </div>

     <div class="clearfix mg-top25">
      <div class="left wd-375">
       <p>a）パルス幅制御による調光<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dimming under pulse-width control.</p>
       <p class="mg-top18">電源の出力を高周波で駆動させ、LEDに流す電流は一定でパルスのデューティー幅を可変して調光する方式。<br />
         LEDに流す電流は一定のため色味の変化は少ないです。<br />
         出力を高周波でスイッチングしているため配線の引き回しに依ってはノイズの発生が考えられます。</p>
       <p class="mg-top18">In this method, an LED driven by a constant current at high frequency is dimmed by varying the pulse duty width of the constant current supplied from a power supply. The tint change the LED is small because the driving current level is constant. Noise may be generated depending on the wire routing because the output is switched at high frequency.<br />
       </p>
      </div>
      <div class="right"><img src="images/item07.gif" alt="パルス幅制御による調光" width="471" height="359" /></div>
     </div>

     <div class="technical_led_box06">
      <div class="clearfix">
       <div class="left wd-413">
        <p class="fs14"><strong>制限抵抗による電流制御</strong></p>
        <p class="mg-top7">ほぼ全てのLED照明においてLEDと直列に電流制限用の制限抵抗を実装しています。（一部実装していない照明もあります。）<br />
          定電圧源に接続すれば容易で安価な定電流回路を構成することができます。</p>
       </div>
       <div class="left pd-left15 pd-right15"><img src="images/line04.gif" width="1" class="l_h03" /></div>
       <div class="left wd-413">
        <p class="fs14"><strong>Current control with limiting resistor</strong></p>
        <p class="mg-top7">Almost all LED lighting models incorporate a current limiting resistor in series with the LEDs. (There are some models without any limiting resistor.) Each LED fixture connected to a constant voltage source will configure a low-cost constant current circuit.</p>
       </div>
      </div>
     </div>
