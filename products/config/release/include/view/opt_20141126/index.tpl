 ...
 <div id="wrapper">
  ...
  <div id="header_box">
   ...
   <div id="topbtnbox" class="clearfix">
    <div class="left"><a href="products/led/index.php"><img src="images/topbtn01_off.jpg" alt="画像処理用LED照明" width="300" height="150" /></a></div>
    <div class="left mg-left30"><a href="products/fluorescent/index.php"><img src="images/topbtn02_off.jpg" alt="画像処理用蛍光灯照明" width="300" height="150" /></a></div>
    <div class="left mg-left30"><a href="products/xenon/index.php"><img src="images/topbtn03_off.jpg" alt="キセノン管ストロボ装置" width="300" height="150" /></a></div>
   </div>
...
・オプトエレクトロニクスダウンロードコンテンツ内 → その他 →『光読本 LED編 VOL.2』
     ...
     <div class="clearfix mg-top30">
      <div class="left"><a href="/"><img src="images/bn01_off.jpg" alt="京都電機器株式会社" width="318" height="81" /></a></div>
      <div class="right"><a href="/products/power/"><img src="images/bn02_off.jpg" alt="Power Electronics" width="318" height="81" /></a></div>
     </div>

    </div>

    <div id="contents_right">
     <div><a href="catalog/index.html"><img src="images/sidebn01_off.jpg" alt="電子カタログはこちら" width="270" height="128" /></a></div>
