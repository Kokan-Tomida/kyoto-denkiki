...
<meta name="keywords" content="お申込みフォーム,画像処理用LED,LED,照明,画像処理,蛍光灯照明,キセノン管ストロボ装置,電源,京都電機器,オプトエレクトロニクス">
<meta name="description" content="サンプル機貸し出しお申込みフォームです。京都電機器オプトエレクトロニクス事業では、画像処理LEDの照明などの画像処理分野を中心に、その周辺機器などを取り扱っています。">
...
<div id="subwrapper">
  ...
  <div id="subheader_box">
    ...
    <div class="clearfix">
     <div class="left"><h1>サンプル機貸し出しお申込みフォーム｜オプトエレクトロニクス事業｜京都電機器株式会社</h1></div>
  ...
  <div id="subcontents_box">
    ...
    <p class="fs14"><strong>ご希望の貸し出し製品を各項目に沿って入力いただき、<br />
      貸し出し期間などを入力いただきましたら追って弊社担当より、ご案内させていただきます。</strong></p>
