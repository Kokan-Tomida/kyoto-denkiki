...
<head>
<link rel="canonical" href="https://www.kdn.co.jp/products/opt/sitemap/" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="サイトマップ,画像処理用LED,LED,照明,画像処理,蛍光灯照明,キセノン管ストロボ装置,電源,京都電機器,オプトエレクトロニクス">
<meta name="description" content="サイトマップ。京都電機器オプトエレクトロニクス事業では、画像処理LEDの照明などの画像処理分野を中心に、その周辺機器などを取り扱っています。">
 ...
 <div id="subwrapper">
  ...
  <div id="subheader_box">
   <div id="subheader" class="clearfix">
    ...
    <div class="clearfix">
     <div class="left"><h1>サイトマップ｜オプトエレクトロニクス事業｜京都電機器株式会社</h1></div>
