...
<head>
<link rel="canonical" href="https://www.kdn.co.jp/products/opt/information/" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="インフォメーション,画像処理用LED,LED,照明,画像処理,蛍光灯照明,キセノン管ストロボ装置,電源,京都電機器,オプトエレクトロニクス">
<meta name="description" content="インフォメーション一覧をご紹介しています。京都電機器オプトエレクトロニクス事業では、画像処理LEDの照明などの画像処理分野を中心に、その周辺機器などを取り扱っています。">
<meta http-equiv="Content-Style-Type" content="text/css">
<meta http-equiv="Content-Script-Type" content="text/javascript">
<meta name="robots" content="index,follow">
<title>インフォメーション｜オプトエレクトロニクス事業｜京都電機器株式会社</title>
...
<![endif]-->
<script type="text/javascript" src="../common/js/kirikae03.js"></script>
<style type="text/css">
div#news2013,
div#news2014,
div#news2015{
...
div#pankuzu2013 a:link,
div#pankuzu2013 a:visited,
div#pankuzu2013 a:hover,
div#pankuzu2013 a:active{
	text-decoration:none;
}
div#pankuzu2014 a:link,
div#pankuzu2014 a:visited,
div#pankuzu2014 a:hover,
div#pankuzu2014 a:active{
	text-decoration:none;
}
div#pankuzu2015 a:link,
div#pankuzu2015 a:visited,
div#pankuzu2015 a:hover,
div#pankuzu2015 a:active{
	text-decoration:none;
}
</style>
</head>
 ...
 <div id="subwrapper">
  ...
  <div id="subheader_box">
   <div id="subheader" class="clearfix">
    ...
    <div class="clearfix">
     <div class="left"><h1>インフォメーション｜オプトエレクトロニクス事業｜京都電機器株式会社</h1></div>
     <div class="right lo_text txtright"><?header_link?></div>
    </div>

    <div class="clearfix">
     <div class="left mg-top6"><a href="<?this_root_url_opt?>"><img src="../common/images/logo.png" alt="Opt Electronics　オプトエレクトロニクス事業" width="537" height="24" class="png" /></a></div>
     <div class="left">
   ...
   <div id="pankuzu"><a href="../index.php">TOP</a> &gt; インフォメーション一覧</div>
   <div id="pankuzu2013"><a href="../index.php">TOP</a> &gt; <a href="javascript:;" onClick="javascript:mouseon00()">インフォメーション一覧</a> &gt; 2013年</div>
   <div id="pankuzu2014"><a href="../index.php">TOP</a> &gt; <a href="javascript:;" onClick="javascript:mouseon00()">インフォメーション一覧</a> &gt; 2014年</div>
   <div id="pankuzu2015"><a href="../index.php">TOP</a> &gt; <a href="javascript:;" onClick="javascript:mouseon00()">インフォメーション一覧</a> &gt; 2015年</div>
   ...
   <div id="subcontents_box">
    ...
    <h2 class="mg-top11 mg-bottom27"><img src="images/titlebar.gif" alt="インフォメーション　Information" width="960" height="42" /></h2>

    <div class="clearfix mg-top30">
    <div class="left wd-200">
     <div class="infobtn01"><a href="javascript:;" onClick="javascript:mouseon03()"><img src="images/arrow.gif" width="6" height="9" class="pd-right5" />2015年</a></div>
     <div class="infobtn01"><a href="javascript:;" onClick="javascript:mouseon02()"><img src="images/arrow.gif" width="6" height="9" class="pd-right5" />2014年</a></div>
     <div class="infobtn01 bbottom"><a href="javascript:;" onClick="javascript:mouseon01()"><img src="images/arrow.gif" width="6" height="9" class="pd-right5" />2013年</a></div>
    </div>
    <div class="right wd-720">

      <h3 class="news_title">ニュースリリース</h3>

      <!-- set -->
      <div class="clearfix mg-top30 fs_grey">
        <div class="left wd-60 pd-left15"><img src="../images/infophoto02.jpg" width="60" height="60" /></div>
        <div class="left wd-610 pd-left20">
         <p>2015年4月9日</p>
         <p class="mg-top4"><a href="/products/opt/pdf/20150409_Long-arc_EOL.pdf">「キセノン管ストロボ照明装置」の生産終了のご案内</a></p>
        </div>
       </div>
      <div class="mg-top26"><img src="images/line.gif" width="720" height="1" /></div>
      <!-- /set -->
...
・オプトエレクトロニクスダウンロードコンテンツ内 → その他 →『光読本 LED編 VOL.2』</p>
        </div>
       </div>
      <div class="mg-top26"><img src="images/line.gif" width="720" height="1" /></div>
      <!-- /set -->
      ...
      <!-- set -->
      <div class="clearfix mg-top30 fs_grey">
        <div class="left wd-60 pd-left15"><img src="../images/infophoto03.gif" width="60" height="60" /></div>
        <div class="left wd-610 pd-left20">
         <p>2013年11月29日</p>
         <p class="mg-top4"><strong>2015年度新卒採用の応募受付開始、採用特設サイトがオープンしました。</strong></p>
<p class="mg-top12">京都電機器株式会社では、採用特設サイトを開設し、2015年度の新卒採用応募受付を開始しました。「POWER RECRUITING」をコンセプトに、社員インタビューや京都電機器の事業・技術の詳しい紹介などを掲載していきます。弊社にご興味のある方はぜひ一度ご覧ください。<br />
  ［<a href="http://kdn-careers.com">京都電機器　採用特設サイト</a>］</p>
        </div>
       </div>
      <div class="mg-top26"><img src="images/line.gif" width="720" height="1" /></div>
      <!-- /set -->
      ...
      <div class="clearfix mg-top30 fs_grey">
        ...
        <div class="left wd-610 pd-left20">
         <p>2013年11月11日</p>
         <p>新製品シートカタログ（PDF）を掲載いたしました。<br />
         ・<a href="../pdf/KDPL2_series.pdf" target="_blank">「KDPL2 series」（高輝度LEDライン照明）</a><br />
・<a href="../pdf/DLA_series.pdf" target="_blank">「DLA series」（PWM制御LED照明点灯電源）</a><br />
・<a href="../pdf/LPA_series.pdf" target="_blank">「LPA series」（パワーLEDスポット照明 専用点灯電源）</a><br />
・<a href="../pdf/LGA_302_leaf.pdf" target="_blank">「LGA-302」（ストロボ発光用LED点灯電源）</a><br />
・<a href="../pdf/new_lineup_leaf.pdf" target="_blank">「LEK-308/508」「LFM-30」「LDA-304/504」</a></p>
        </div>
       </div>
      <div class="mg-top26"><img src="images/line.gif" width="720" height="1" /></div>
      <!-- /set -->
      <!-- set -->
      <div class="clearfix mg-top30 fs_grey">
        <div class="left wd-60 pd-left15"><img src="../images/infophoto01.jpg" width="60" height="60" /></div>
        <div class="left wd-610 pd-left20">
         <p>2013年10月15日</p>
         <p><a href="https://www.kdn.co.jp/products/opt/catalog/" target="_blank" class="news02">オプトエレクトロニクス光学機器総合カタログの電子カタログ版を掲載いたしました。</a></p>
        </div>
       </div>
      <div class="mg-top26"><img src="images/line.gif" width="720" height="1" /></div>
      <!-- /set -->
      ...
      <div class="clearfix mg-top30 fs_grey">
        ...
        <div class="left wd-610 pd-left20">
         <p>2013年10月15日</p>
         <p>オプトエレクトロニクス製品情報サイトをオープンいたしました。<br />充実した製品情報を掲載し、新製品等の最新情報についても、いち早くお届けしてまいります。</p>
        </div>
       </div>
      <div class="mg-top26"><img src="images/line.gif" width="720" height="1" /></div>
      <!-- /set -->
     ...
     <div class="right wd-240 mg-top30">
      ...
      <div class="f_space12 mg-left18">
       <ul class="ful">
        ...
        <li><img src="../common/images/ico01.gif" width="7" height="7" class="pd-right5" /><a href="index.php">インフォメーション</a></li>
