...
<head>
<link rel="canonical" href="https://www.kdn.co.jp/products/opt/download/" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="ダウンロード,画像処理用LED,LED,照明,画像処理,蛍光灯照明,キセノン管ストロボ装置,電源,京都電機器,オプトエレクトロニクス">
<meta name="description" content="ダウンロードコンテンツのログイン画面です。オプトエレクトロニクス製品では、取扱説明書や外形図のPDF、もしくはDXFファイルなどをご利用いただけます。京都電機器オプトエレクトロニクス事業では、画像処理LEDの照明などの画像処理分野を中心に、その周辺機器などを取り扱っています。">
<meta http-equiv="Content-Style-Type" content="text/css">
<meta http-equiv="Content-Script-Type" content="text/javascript">
<meta name="robots" content="index,follow">
<title>ダウンロードコンテンツ｜オプトエレクトロニクス事業｜京都電機器株式会社</title>
 ...
 <div id="subwrapper">
  ...
  <div id="subheader_box">
   <div id="subheader" class="clearfix">
    ...
    <div class="clearfix">
     <div class="left"><h1>ダウンロードコンテンツ｜オプトエレクトロニクス事業｜京都電機器株式会社</h1></div>
   ...
   <div id="subcontents_box">
     <div id="subcontents_top">
       <h2><img src="images/titlebar.gif" alt="ダウンロードコンテンツ" width="960" height="42" /></h2>

       <p class="fs14 mg-top23"><strong>オプトエレクトロニクス製品では、取扱説明書や外形図のPDF、もしくはDXFファイルなどをご利用いただけます。<br />まずは<a href="<?this_root_url_member?>">こちら</a>で会員登録（無償）を行って下さい。<br />既に会員アカウントをお持ちの方は下記よりログインしてお申し込み下さい。</strong></p>
     </div><!--/#subcontents_top-->
     <div id="login">
       <div id="login_bg">
