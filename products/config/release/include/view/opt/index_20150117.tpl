...
<head>
<link rel="canonical" href="https://www.kdn.co.jp/products/opt/" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="画像処理用LED,LED,照明,画像処理,蛍光灯照明,キセノン管ストロボ装置,電源,京都電機器,オプトエレクトロニクス">
<meta name="description" content="画像処理用LEDの照明、高度FAシステムを支える画像処理分野を中心に、照明・蛍光灯照明、キセノン管ストロボ装置、電源等さまざまな光学照明製品 や周辺機器・サービスを提供している京都電機器オプトエレクトロニクス事業製品情報サイトです。">
<meta http-equiv="Content-Style-Type" content="text/css">
<meta http-equiv="Content-Script-Type" content="text/javascript">
<meta name="robots" content="index,follow">
<title>画像処理用LED照明の京都電機器オプトエレクトロニクス事業</title>
 ...
 <div id="wrapper">
  ...
  <div id="header_box">
   <div id="header" class="clearfix">
    ...
    <div class="clearfix">
     <div class="left mg-top6"><img src="common/images/logo.png" alt="Opt Electronics　オプトエレクトロニクス事業" width="537" height="24" class="png" /></div>
     <div class="left">
   ...
   <li class="fb"><iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.kdn.co.jp%2Fproducts%2Fopt%2F&amp;width&amp;layout=button_count&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=2" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:21px;" allowTransparency="true"></iframe></li>
   
   <li class="g_plus"><div class="g-plusone" data-size="medium"></div></li>
   
   <li class="hatena_b"><a href="http://b.hatena.ne.jp/entry/https://www.kdn.co.jp/products/opt/" class="hatena-bookmark-button" data-hatena-bookmark-title="画像処理用LED照明の京都電機器オプトエレクトロニクス事業" data-hatena-bookmark-layout="simple-balloon" title="このエントリーをはてなブックマークに追加"><img src="https://b.hatena.ne.jp/images/entry-button/button-only@2x.png" alt="このエントリーをはてなブックマークに追加" width="20" height="20" style="border: none;" /></a><script type="text/javascript" src="https://b.hatena.ne.jp/js/bookmark_button.js" charset="utf-8" async="async"></script></li>
   
   <li class="twitter last"><a href="https://twitter.com/share" class="twitter-share-button" data-url="https://www.kdn.co.jp/products/opt/" data-lang="ja">ツイート</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script></li>
   ...
   <h2 id="intro_ttl"><img src="images/top_intro_ttl.gif" width="258" height="16" alt="画像処理用照明とは? About LED lighting" /></h2>

   <div id="intro_box">
   <div class="head"></div>
   <p class="txt">例えば明暗ムラ（シェーディング）や局所的に真っ白にとんでしまうような反射（ハレーション）がないような均一照明状態をつくることなどを目的に選定されたものが画像処理用照明と言われています。画像処理をする上で照明の選定は重要な要素です。京都電機器では画像処理・画像検査用LED照明としてリング照明やバー照明をはじめ、ドーム照明、バックライト、同軸落射照明、スポット照明、紫外/赤外照明などを幅広く揃えています。</p>
   </div>
   
   <div id="topbtnbox" class="clearfix">
    <div class="left">
    <a href="products/led/index.php"><img src="images/topbtn01_off.jpg" alt="画像処理用LED照明" width="300" height="150" /></a>
    <p class="txt_area txt01">LEDを使用した画像処理用の各種照明、電源を設計・製作しています。近年LEDは画像処理検査機やWEB検査機のみならず住宅、自動車関連の需要も広がり、技術革新のめざましい分野です。京都電機器はそういったお客様のご要望にマッチした照明と電源をご提供いたします。</p>
    </div>
    
    <div class="left mg-left30">
    <a href="products/fluorescent/index.php"><img src="images/topbtn02_off.jpg" alt="画像処理用蛍光灯照明" width="300" height="150" /></a>
    <p class="txt_area txt02">画像処理用蛍光灯高周波点灯電源は当社の光学機器製品のさきがけとなった商品です。<br />用途に合わせて豊富なラインナップ（10～110W、シンプル～高機能）があります。RoHS対応機種もご用意しております。</p>
    </div>
    
    <div class="left mg-left30">
    <a href="products/xenon/index.php"><img src="images/topbtn03_off.jpg" alt="キセノン管ストロボ装置" width="300" height="150" /></a>
    <p class="txt_area txt03">発光色（スペクトル）が自然光（太陽光）に極めて近いキセノンランプの特性を生かし、モーション、動体の測定だけでなく、幅広い画像処理分野のお役に立っています。出力10～1200Ｗ、発光周波数20～100Hz等、様々な用途にお使いいただけます。</p>
    </div>
   </div>
...
<div class="info_innerbox">
      ...
      <div class="clearfix pd-top15">
        ...
        <div class="left wd-535 pd-left20">
         ...
         <p class="mg-top12">ホームページリニューアルに伴い、会員登録していただいた方にもれなく『光読本 LED編 VOL.2』を無料でプレゼントいたします。<br />
関連エンジニアの方々にとって、お役立ち情報が満載ですので、この機会に是非ご活用ください。<br />
[<a href="<?this_root_url_member?>/">会員登録／ログインはこちらから</a>]　<br />
※技術ノウハウ冊子は、ログイン後の会員メニューからダウンロードできます。<br />
・オプトエレクトロニクスダウンロードコンテンツ内 → その他 →『光読本 LED編 VOL.2』
        </div>
       </div>
     ...
     <div class="clearfix mg-top30">
      <div class="left"><a href="http://www.kdn.co.jp/"><img src="images/bn01_off.jpg" alt="京都電機器株式会社" width="318" height="81" /></a></div>
      <div class="right"><a href="https://www.kdn.co.jp/products/power/"><img src="images/bn02_off.jpg" alt="Power Electronics" width="318" height="81" /></a></div>
     </div>
     
    </div>
    
    <div id="contents_right">
     <div><a href="https://www.kdn.co.jp/products/opt/catalog/" target="_blank"><img src="images/sidebn01_off.jpg" alt="電子カタログはこちら" width="270" height="128" /></a></div>
     
     <div class="side_bnbox">
      <div><a href="products/custom/index.php"><img src="images/sidebn02_off.jpg" alt="カスタム照明の制作について" width="255" height="112" /></a></div>
      <div class="mg-top8"><a href="<?this_root_url_opt_sample?>"><img src="images/sidebn03_off.jpg" alt="サンプル機貸し出し依頼" width="253" height="60" /></a></div>
      <div class="mg-top10"><a href="products/stop/index.php"><img src="images/sidebn04_off.gif" alt="生産中止製品について" width="252" height="37" /></a></div>
      <div class="mg-top47 mg-left16">
       <span class="fs_blue">●</span><a href="technical/led/index.php">画像処理用LED照明</a><br />
       <span class="fs_blue">●</span><a href="technical/fluorescent/index.php">画像処理用蛍光灯照明</a><br />
       <span class="fs_blue">●</span><a href="technical/xenon/index.php">キセノン管ストロボ装置</a>
      </div>
     </div>
    </div>
