...
<meta name="description" content="サンプル機貸し出しについてご紹介しています。京都電機器オプトエレクトロニクス事業では、画像処理LEDの照明などの画像処理分野を中心に、その周辺機器などを取り扱っています。">
...
<div id="subwrapper">
  ...
  <div id="subheader_box">
    ...
    <div class="clearfix">
     <div class="left"><h1>サンプル機貸し出しについて｜オプトエレクトロニクス事業｜京都電機器株式会社</h1></div>
