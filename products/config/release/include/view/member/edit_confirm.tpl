  <div id="pankuzu"><a href="menu.php">会員メニュー</a> &gt; 会員編集確認</div>
  <!-- contents_box start -->
  <div id="contents_box">
    <h2 class="mg-top11 mg-bottom23"><img src="images/titlebar07.gif" alt="会員編集確認" width="960" height="42" /></h2>
    
    <p class="sample_text02 txtcenter pd-top6">入力内容に間違いが無ければ、編集ボタンを押してください。</p>
    
    <form method="post" name="frm" id="frm" action="edit_confirm.php">
...
<div class="left"><input type="submit" name="to_complete" id="to_complete" value="" class="edit_btn" /></div>
