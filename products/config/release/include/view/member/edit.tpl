  <div id="pankuzu"><a href="menu.php">会員メニュー</a> &gt; 会員情報編集フォーム</div>
  <!-- contents_box start -->
  <div id="contents_box">
    <h2 class="mg-top11"><img src="images/titlebar06.gif" alt="会員情報編集フォーム" width="960" height="42" /></h2>
    
    <p class="mg-top27">会員情報編集は、下記フォームにご入力下さい。</p>
    ...
    <form method="post" name="frm" id="frm" action="edit.php">
          ...
          <div class="pd-left32 pd-right34 wd-860">
            <table width="860" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><input class="input01" type="text" name="company_name" id="company_name" size="30" style="ime-mode:active" value="<?company_name?>" /></td>
              </tr>
              <tr>
              ...
              <tr>
                <th>パスワード <span class="fs_crimson">※</span></th>
                <td>
                <input class="input05" type="text" name="member_pwd" id="member_pwd" size="30" style="ime-mode:inactive" value="<?member_pwd?>" />
                <input type="hidden" name="member_pwd_hidden" id="member_pwd_hidden" value="<?member_pwd?>" />
                </td>
              </tr>
              <tr>
                <th>備考</th>
       ...
       <div class="clearfix mg-left264">
		...
		<div class="clearfix mg-left264 pd-top25 pd-bottom33">
          <div class="left">
            ...
            <input type="submit" name="to_confirm" value=" " class="edit_conf_btn" />
          </div>
          <div class="left">
