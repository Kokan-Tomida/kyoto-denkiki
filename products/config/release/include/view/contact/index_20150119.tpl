...
<title>お問い合わせ｜パワーエレクトロニクス事業/オプトエレクトロニクス事業｜京都電機器株式会社</title>
...
<script type="text/javascript">
DD_belatedPNG.fix('.png, .sample_inner_box, .conf_btn, .reset_btn, .submit_btn, .back_btn, .login_btn');
</script>
<![endif]-->
</head>
<body>
...
<div id="wrapper">
  ...
  <div id="contents_box">
    ...
    <div class="pd-bottom17 pd-top29 btop02"><img src="images/login_text01.gif" alt="メールでのお問い合わせ" width="181" height="16" /></div>


<div class="clearfix" id="login">
    <div id="left_login">
<div id="login_bg">
  <p class="mg-top16 txtcenter"><img src="images/member_bg .gif" alt="会員の方" width="150" height="30" class="member_login" /></p>
            <div>会員アカウントをお持ちの方は下記よりログインしていただきますと<br />名前、住所などの入力項目が簡略化されます。</div>
    <form method="post" action="#">
      ...
      <tr>
          <td width="90" height="30" ><div align="right" class="pd-top18"><img src="images/login_bg_con_e.gif"></div></td>
          <td> <input type="text" class="mg-top18 mg-left20 w01" size="30" name="member_id"></td>
          </tr>
      <tr>
          <td width="90" height="30"><div align="right"><img src="images/login_bg_con_p.gif"></div></td>
...
<p class="mg-top17">パスワードを忘れられた方は<a href="<?this_root_url_contact_guest?>">お問い合せフォーム</a>より、お問い合わせ種別で「パスワード再発行」を選んでご登録されましたメールアドレスで再発行をお申し込み下さい。</p>
    ...
    <div id="right_login">
<div class="nomember_bg txtcenter"><a href="<?this_root_url_contact_guest?>"><img src="images/contact_btn.gif" alt="お問い合わせフォーム" width="300" height="71" /></a></div>
    </div><!--/#login-->

<!--    <div class="clearfix">

     <div class="left wd-460">
      <div>
      <form method="post" action="index.php">
       <div class="login_bg">
        <div class="txtcenter pd-top47">会員アカウントをお持ちの方は下記よりログインしていただきますと<br />名前、住所などの入力項目が簡略化されます。</div>
        <div class="pd-left127 pd-top18"><input class="w01" type="text" name="member_id"></div>
        <div class="pd-left127 pd-top10"><input class="w01" type="password" name="member_pwd"></div>
                <?validate_msg?>
                        <div class="pd-left162 pd-top20"><input type="submit" name="to_login" value=" " class="login_btn" /></div>
       </div>
      </form>
      </div>

      <div class="mg-top17 forget_text">パスワードを忘れられた方は<a href="<?this_root_url_contact_guest?>">お問い合せフォーム</a>より、お問い合わせ種別で「パスワード再発行」を選んでご登録されましたメールアドレスで再発行をお申し込み下さい。</div>
     </div>

     <div class="right wd-460">
      <div class="nomember_bg txtcenter"><a href="<?this_root_url_contact_guest?>"><img src="images/contact_btn.gif" alt="お問い合わせフォーム" width="301" height="69" /></a></div>
     </div>
