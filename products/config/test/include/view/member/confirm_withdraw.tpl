  <div id="pankuzu"><a href="menu.php">会員メニュー</a> &gt; 退会申請確認</div>
  <!-- contents_box start -->
  <div id="contents_box">
    <h2 class="mg-top11 mg-bottom23"><img src="images/titlebar09.gif" alt="退会申請確認" width="960" height="42" /></h2>
    
    <p class="sample_text02 txtcenter pd-top6">下記会員様の退会申請を行います。</p>
    
    <form method="post" name="frm" id="frm" action="confirm_withdraw.php">
...
<div class="left"><input type="submit" name="to_complete" id="submit" value="" class="withdraw_btn" /></div>
<div class="left"><input type="submit" name="to_back" id="back" value="" class="back_btn" /></div>
</div>
