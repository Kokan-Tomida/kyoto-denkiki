...
<div class="left"><input type="submit" name="to_complete" id="to_complete" value="" class="submit_btn" /></div>
<div class="left"><input type="submit" name="to_return" id="to_return" value="" class="back_btn" /></div>
</div>
