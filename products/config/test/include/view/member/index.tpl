...
<div id="wrapper">
  ...
  <!-- contents_box start -->
  <div id="contents_box">
    <h2 class="mg-top11"><img src="images/titlebar01.gif" alt="ログイン／会員登録" width="960" height="42" /></h2>
    <p class="fs14 mg-top17"><strong>京都電機器株式会社サイトの会員登録を行いますと、ダウンロードコンテンツのご利用や、<br />サンプル機貸し出しなどをお申込みいただける様になります。</strong></p>
    
    <div class="clearfix mg-top50 mg-left45 mg-right45">
    
     <div class="left wd-420">
      <div>
      <form method="post" action="#">
       <div class="login_bg">
        <div><input class="w01" type="text" name="member_id"></div>
        <div class="mg-top10"><input class="w01" type="password" name="member_pwd"></div>
        <div class="mg-top20 pd-left38"><input type="submit" name="to_login" value=" " class="login_btn" /></div>
       </div>
      </form>
      </div>
     ...
     <div class="right wd-420">
      <div class="nomember_bg txtcenter"><a href="<?member_regist_url?>"><img src="images/contact_btn.gif" alt="新規登録" width="300" height="71" /></a></div>
     </div>
