...
<title>サイトマップ｜オプトエレクトロニクス事業｜京都電機器株式会社</title>
<!-- InstanceEndEditable -->
 ...
 <div id="subwrapper">
  ...
  <div id="subheader_box">
   ...
   <div id="subcontents_box">
    ...
    <h2 class="mg-top11 mg-bottom27"><img src="images/titlebar.gif" alt="サイトマップ　Site map" width="960" height="42" /></h2>
    ...
    <div id="sitemap_box" class="clearfix">
     ...
     <p class="sitemap_text01">製品情報</p>
      ...
      <p class="f_space17"><img src="../common/images/ico02.gif" width="6" height="12" class="icotext-middle pd-right5" /><strong><a href="../technical/led/index.php">LED技術資料</a></strong></p>
      ...
      <p class="f_space09"><img src="../common/images/ico03.gif" width="6" height="12" class="icotext-middle pd-right5" /><strong><a href="../technical/fluorescent/index.php">蛍光灯技術資料</a></strong></p>
      
      <p class="f_space10"><img src="../common/images/ico04.gif" width="6" height="12" class="icotext-middle pd-right5" /><strong><a href="../technical/xenon/index.php">キセノンストロボ技術資料</a></strong></p>
      ...
      <div class="f_space12">
       <ul class="ful">
        ...
        <li><a href="../equipment/index.php">設備・サポート</a></li>
        <li><a href="../products/custom/index.php">カスタム照明</a></li>
        <li><a href="../products/stop/index.php">生産中止製品について</a></li>
     ...
     <div class="right wd-240 mg-top30">
      ...
      <div class="f_space12 mg-left18">
       <ul class="ful">
        ...
        <li class="f_space13"><img src="../common/images/ico01.gif" width="7" height="7" class="pd-right5" /><a href="index.php">サイトマップ</a></li>
